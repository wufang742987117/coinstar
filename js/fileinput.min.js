            ...
            t.prototype = {
                ...
                _init: function(t) {
                    ...
                    r.options = t,
                        ...
                        r._cleanup(),
                        r.$form = o.closest("form"),
                        r._initTemplateDefaults(),
                        r.uploadFileAttr = i.isEmpty(o.attr("name")) ? "file_data": o.attr("name"),
                        n = r._getLayoutTemplate("progress"),
                        r.progressTemplate = n.replace("{class}", r.progressClass),
                        r.progressCompleteTemplate = n.replace("{class}", r.progressCompleteClass),
                        r.progressErrorTemplate = n.replace("{class}", r.progressErrorClass),
                        r.dropZoneEnabled = i.hasDragDropSupport() && r.dropZoneEnabled,
                        r.isDisabled = o.attr("disabled") || o.attr("readonly"),
                    r.isDisabled && o.attr("disabled", !0),
                        r.isUploadable = i.hasFileUploadSupport() && !i.isEmpty(r.uploadUrl),
                        r.isClickable = r.browseOnZoneClick && r.showPreview && (r.isUploadable && r.dropZoneEnabled || !i.isEmpty(r.defaultPreviewContent)),
                        r.slug = "function" == typeof t.slugCallback ? t.slugCallback: r._slugDefault,
                        r.mainTemplate = r.showCaption ? r._getLayoutTemplate("main1") : r._getLayoutTemplate("main2"),
                        r.captionTemplate = r._getLayoutTemplate("caption"),
                        r.previewGenericTemplate = r._getPreviewTemplate("generic"),
                    r.resizeImage && (r.maxImageWidth || r.maxImageHeight) && (r.imageCanvas = document.createElement("canvas"), r.imageCanvasContext = r.imageCanvas.getContext("2d")),
                    i.isEmpty(o.attr("id")) && o.attr("id", i.uniqId()),
                        r.namespace = ".fileinput_" + o.attr("id").replace(/-/g, "_"),
                        void 0 === r.$container ? r.$container = r._createContainer() : r._refreshContainer(),
                        a = r.$container,
                        r.$dropZone = a.find(".file-drop-zone"),
                        r.$progress = a.find(".kv-upload-progress"),
                        r.$btnUpload = a.find(".fileinput-upload"),
                        r.$captionContainer = i.getElement(t, "elCaptionContainer", a.find(".file-caption")),
                        r.$caption = i.getElement(t, "elCaptionText", a.find(".file-caption-name")),
                        r.$previewContainer = i.getElement(t, "elPreviewContainer", a.find(".file-preview")),
                        r.$preview = i.getElement(t, "elPreviewImage", a.find(".file-preview-thumbnails")),
                        r.$previewStatus = i.getElement(t, "elPreviewStatus", a.find(".file-preview-status")),
                        r.$errorContainer = i.getElement(t, "elErrorContainer", r.$previewContainer.find(".kv-fileinput-error")),
                    i.isEmpty(r.msgErrorClass) || i.addCss(r.$errorContainer, r.msgErrorClass),
                        r.$errorContainer.hide(),
                        r.previewInitId = "preview-" + i.uniqId(),
                        r._initPreviewCache(),
                        r._initPreview(!0),
                        r._initPreviewActions(),
                        r._setFileDropZoneTitle(),
                        o.removeClass("file-loading"),
                    o.attr("disabled") && r.disable(),
                        r._initZoom()
                },
                ...
                _clearPreview: function() {
                    ...
                    t.$preview.find(i.FRAMES).length && t.showPreview || t._resetUpload(),
                ...
                _setZoomContent: function(t, a) {
                    ...
                    c && (d = s.find(".kv-preview-data"), i.addCss(d, "file-zoom-detail"), e.each(c,
                        ...
                        h.data("previewId", v);
                    var E = s.find("img");
                    E.length && i.adjustOrientedImage(E, !0),
                        m._handler(g, "click",
                            function() {
                ...
                _zoomSlideShow: function(t, a) {
                    var n, r, o, l = this,
                        ...
                        c = d.length;
                    if (!s.attr("disabled")) {
                        for (r = 0; c > r; r++) if (e(d[r]).attr("id") === a) {
                            o = "prev" === t ? r - 1 : r + 1;
                            break
                        }
                        0 > o || o >= c || !d[o] || (n = e(d[o]), n.length && l._setZoomContent(n, !0), l._initZoomButtons(), l._raise("filezoom" + t, {
                            previewId: a,
                            modal: l.$modal
                        }))
                    }
                ...
                _getThumbs: function(e) {
                    return e = e || "",
                        this.$preview.find(i.FRAMES + ":not(.file-preview-initial)" + e)
                },
                                    ...
                                    r !== !1 && a.fadeOut("slow",
                                        function() {
                                            i.cleanZoomCache(n.find("#zoom-" + e)),
                                                a.remove(),
                                            n.find(i.FRAMES).length || t.reset()
                                        })
                                })
                    })
                },
                ...
                _generatePreviewTemplate: function(t, a, n, r, o, l, s, d, c, u, p) {
                    ...
                    m.fileActionSettings.showZoom && (h = x(T ? "other": t, a, !0, "kv-zoom-thumb")),
                        h = "\n" + m._getLayoutTemplate("zoomCache").replace("{zoomContent}", h),
                        f = x(E ? "other": t, a, !1, "kv-preview-thumb"),
                    f + h
                },
                    ...
                    n.loadedImages = [],
                        ...
                        a = function(e) {
                            ...
                            var E, T, x, S, F, I, k, P, z, A, $ = v + e,
                                ...
                                O = 0,
                                Z = "";
                            if (g > 0) for (S = 0; g > S; S++) P = h[S],
                                z = n.msgFileTypes[P] || P,
                                Z += 0 === S ? z: ", " + z;
                            if (j === !1) return void a(e + 1);
                            if (0 === j.length) return F = n.msgInvalidFileName.replace("{name}", i.htmlEncode(U.name)),
                                void(n.isError = y(F, U, D, e));
                            if (i.isEmpty(w) || (L = new RegExp("\\.(" + w.join("|") + ")$", "i")), x = R.toFixed(2), n.maxFileSize > 0 && R > n.maxFileSize) return F = n.msgSizeTooLarge.setTokens({
                                name: j,
                                size: x,
                                maxSize: n.maxFileSize
                            }),
                                void(n.isError = y(F, U, D, e));
                            if (null !== n.minFileSize && R <= i.getNum(n.minFileSize)) return F = n.msgSizeTooSmall.setTokens({
                                name: j,
                                size: x,
                            ...
                            if (!i.isEmpty(h) && i.isArray(h)) {
                                for (S = 0; S < h.length; S += 1) I = h[S],
                                    A = m[I],
                                    O += A && "function" == typeof A && A(U.type, U.name) ? 1 : 0;
                                if (0 === O) return F = n.msgInvalidFileType.setTokens({
                                    name: j,
                                    types: Z
                                }),
                                    void(n.isError = y(F, U, D, e))
                            ...
                            return 0 !== O || i.isEmpty(w) || !i.isArray(w) || i.isEmpty(L) || (k = i.compare(j, L), O += i.isEmpty(k) ? 0 : k.length, 0 !== O) ? n.showPreview ? !C && R > b ? (n.addToStack(U), s.addClass("file-thumb-loading"), n._previewDefault(U, D), n._initFileActions(), n._updateFileDetails(f), void a(e + 1)) : (o.length && void 0 !== FileReader ? (d.html(c.replace("{index}", e + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function(e) {
                                ...
                                E = m.text, T = m.image, E(U.type, j) ? l.readAsText(U, n.textEncoding) : T(U.type, j) ? l.readAsDataURL(U) : l.readAsArrayBuffer(U)) : (n._previewDefault(U, D), setTimeout(function() {
                                    a(e + 1),
                                        n._updateFileDetails(f)
                                },
                                ...
                                100), void n._raise("fileloaded", [U, D, e, l])) : (F = n.msgInvalidFileExtension.setTokens({
                                name: j,
                                extensions: _
                            }), void(n.isError = y(F, U, D, e)))
                        },
                ...
                _validateImage: function(e, i, t, a) {
                    var n, r, o, l = this,
                        ...
                        u = d.find("img");
                    i = i || "Untitled",
                    u.length && l._handler(u, "load",
                        function() {
                            r = d.width(),
                                o = s.width(),
                            r > o && (u.css("width", "100%"), d.css("width", "97%")),
                                n = {
                                    ind: c,
                                    id: e
                                },
                                l._checkDimensions(c, "Small", u, d, i, "Width", n),
                                l._checkDimensions(c, "Small", u, d, i, "Height", n),
                            l.resizeImage || (l._checkDimensions(c, "Large", u, d, i, "Width", n), l._checkDimensions(c, "Large", u, d, i, "Height", n)),
                                l._raise("fileimageloaded", [e]),
                                l.loadedImages.push({
                                    ind: c,
                                    img: u,
                                    thumb: d,
                ...
                _getResizedImage: function(i, t, a) {
                    var n, r, o, l, s = this,
                        ...
                        C = i.thumb;
                    if (o = function(e, i, t) {
                        s.isUploadable ? s._showUploadError(e, i, t) : s._showError(e, i, t),
                            s._setPreviewError(C, b)
                    },
                    (!s.filestack[b] || !v || f >= c && m >= u) && (v && s.filestack[b] && s._raise("fileimageresized", [_, b]), t.val++, t.val === a && s._raise("fileimagesresized"), !v)) return void o(s.msgImageResizeError, {
                            id: _,
                            index: b
                        },
                        "fileimageresizeerror");
                    w = w || s.resizeDefaultImageType,
                        n = c > f,
                        r = u > m,
                        p = "width" === s.resizePreference ? n ? f / c: r ? m / u: 1 : r ? m / u: n ? f / c: 1,
                        s._resetCanvas(),
                        c *= p,
                        u *= p,
                        h.width = c,
                        h.height = u;
                    try {
                        g.drawImage(d, 0, 0, c, u),
                            h.toBlob(function(e) {
                                    s.filestack[b] = e,
                                        s._raise("fileimageresized", [_, b]),
                                        t.val++,
                                    t.val === a && s._raise("fileimagesresized", [void 0, void 0]),
                        ...
                        t.val++,
                        t.val === a && s._raise("fileimagesresized", [void 0, void 0]),
                            l = s.msgImageResizeException.replace("{errors}", y.message),
                            o(l, {
                                    id: _,
                                    index: b
                                },
                ...
                _createContainer: function() {
                    ...
                    return i.$element.before(t),
                        i._initBrowse(t),
                    i.theme && t.addClass("theme-" + i.theme),
                        t
                },
                ...
                reset: function() {
                    ...
                    (e.$preview.find(i.FRAMES).length || e.isUploadable && e.dropZoneEnabled) && e.$container.removeClass("file-input-new"),
